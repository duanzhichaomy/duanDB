export default {
  ...
  'workspace.renameTable.currentName': '当前表名：{1}',
  'workspace.renameTable.placeholder': '请输入新的表名',
  'workspace.renameTable.nameRequired': '请输入新的表名',
  'workspace.renameTable.nameSame': '新表名不能和当前表名相同',
  'workspace.renameTable.failed': '重命名表失败',
