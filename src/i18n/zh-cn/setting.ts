export default {
  ...
  'setting.placeholder.chat2dbApiKey': '使用DuanDB提供的APIKEY',
  ...
  'setting.button.checkUpdate': '检查更新',
  ...
  'setting.chat2db.ai.button': '请前往 DuanDB Pro 体验更为强大的AI功能',
  'setting.title.goto.chat2db.pro': '前往DuanDB Pro',
};
