export default {
  ...
  'setting.title.pageSize': 'Rows Per Page',
  ...
  'setting.placeholder.chat2dbApiKey': 'Use the APIKEY provided by DuanDB',
  ...
  'setting.button.checkUpdate': 'Check for Updates',
  ...
  'setting.chat2db.ai.button': 'Please visit DuanDB Pro for more powerful AI features',
  'setting.title.goto.chat2db.pro': 'Go to DuanDB Pro',
};
