export default {
  ...
  'workspace.menu.renameTable': 'Rename Table',
  ...
  'workspace.renameTable.currentName': 'Current table: {1}',
  'workspace.renameTable.placeholder': 'Enter the new table name',
  'workspace.renameTable.nameRequired': 'Please enter the new table name',
  'workspace.renameTable.nameSame': 'The new table name cannot be the same as the current table name',
  'workspace.renameTable.failed': 'Failed to rename table',
